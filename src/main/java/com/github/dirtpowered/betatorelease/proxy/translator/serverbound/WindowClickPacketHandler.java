...
public class WindowClickPacketHandler implements BetaToModernHandler<V1_7_3WindowClickPacketData> {

    @Override
    public void handlePacket(Session session, V1_7_3WindowClickPacketData packetClass) {
