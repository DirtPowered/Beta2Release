...
public class BlockPlacePacketHandler implements BetaToModernHandler<V1_7_3BlockPlacePacketData> {

    @Override
    public void handlePacket(Session session, V1_7_3BlockPlacePacketData packetClass) {
